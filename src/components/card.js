...
function changeColor() {
    ...
    return(
<section className='card col-2 col-lg-12' data-aos='slide-up'>
...
<span onClick={changeColor} className='icon' style={{backgroundColor:flag?'red':'white'}}    ><i style={{color:flag?'white':'red'}}  className="far fa-heart"></i></span>
